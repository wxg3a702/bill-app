...
module.exports = _reactNative2.default.createClass({
    ...
    renderPagination: function renderPagination() {
        ...
        var dots = [];
        var ActiveDot = this.props.activeDot || _reactNative2.default.createElement(_reactNative.View, {
                style: {
        ...
        var Dot = this.props.dot || _reactNative2.default.createElement(_reactNative.View, {
                style: {
