module.exports = {
    UNAUDITING: {desc: "未提交", color: "red", content: '下一步', button: 'next', colorA: '#ff5b58', alter: ''},
    AUDITING: {desc: "认证中", color: "#ffdc35", content: '返回', button: 'back', colorA: '#ff5b58', alter: '认证中，'},
    REJECTED: {desc: "未通过", color: "red", content: '下一步', button: 'next', colorA: '#ff5b58', alter: ''},
    CERTIFIED: {desc: "已认证", color: "#43bb80", content: '返回', button: 'back', colorA: '#44bcb2', alter: '已通过，'},
    licenseCopyFileId: {
